...
```
```{r 9 Added distribution of ABV and IBU in the state of COlorado}
#Ploted ABV and IBU by City in state of Colorado
beer_breweries_with_beer_type %>% 
  filter(State == "CO")%>% 
  group_by(City) %>% 
